...
class Provider implements Service
{
    ...
    public function onRegister()
    {
        ...
        $app->route->attachResource("/project", "App\\Project\\Controller\\Project"); //multiple projects types and status e.g project proposal
        $app->route->attachResource("/task", "App\\Project\\Controller\\Task"); //tasks? tasks are a collection of protocols mark task as results?
